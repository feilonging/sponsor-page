...
var GithubLink  =   "https://github.com/feilongproject/";
var PayPalLink  =   "";
$('#paypal-donate>a').href = PayPalLink;
$('#github-box>a').href = GithubLink;
var qrcodes = {
    'btc_donate'	:	'',	// 二维码路径
    'alipay_donate'	:	'https://feilongproject.com/img/Alipay.png',	// 支付宝二维码
    'alipay_donate_link'   :   'https://qr.alipay.com/fkx12796h3cpbnphue9yi0e',   // 支付宝二维码上的链接，必须换成自己的连接！！！手机点击会自动跳转到支付宝。
    'wechat_donate'	:	'https://feilongproject.com/img/WeChatPay.png'
};
